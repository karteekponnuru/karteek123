...
needs(plyr)
#library(devtools)
#install.packages('monkeylearn', repos='http://cran.us.r-project.org')
needs(monkeylearn)
...
for(i in 1:nrow(Basic_Twitter_Metrics)){
    ...
    Basic_Twitter_Metrics[i,3] <- testtt$text[i]#input[[1]][[1]][[14]][i,5] # We need to check why user: is coming as empty object in free API
